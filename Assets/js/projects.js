 ...
 * To promote:  Change "type" from "archive" to "featured".
 * To demote:   Change "type" from "featured" to "archive".
 * 
 * Featured uses ALL fields. Archive uses: title, domain, descriptionShort,
 * toolStack (first 3 only), demoButton, codeButton.
 */
const PROJECTS = [
    {
        id: "ad4p",
        ...
        toolStack: [
            { icon: "devicon-apachespark-original", label: "PySpark" },
            { icon: "devicon-pytorch-original", label: "PyTorch" },
    ...
    },
    {
        ...
        toolStack: [
            { icon: "ph ph-snowflake", label: "Snowflake" },
            { icon: "ph ph-stack", label: "dbt" },
            { icon: "devicon-apacheairflow-plain", label: "Airflow" },
    ...
    },
    {
        ...
        subtitle: "",
        layout: "normal",
        description: "Statistical Product Decision Engine. A rigorous A/B testing simulator designed to prevent common pitfalls like Sample Ratio Mismatch (SRM) and Simpson's Paradox in product experiments.",
        features: [
        ...
        toolStack: [
            { icon: "devicon-python-plain", label: "SciPy" },
            { icon: "devicon-streamlit-plain", label: "Streamlit" },
            { icon: "devicon-pandas-plain", label: "Pandas" },
            { icon: "devicon-plotly-plain", label: "Plotly" }
        ],
        media: {
            type: "gif",
    ...
    },
    {
        ...
        toolStack: [
            ...
            { icon: "ph ph-snowflake", label: "Snowflake" },
            { icon: "devicon-python-plain", label: "Python" },
            { icon: "ph ph-chart-bar", label: "PowerBI" }
        ],
        media: {
            type: "gif",
        ...
        demoButton: {
            label: "🎬 Watch Video",
            url: "https://www.youtube.com/watch?v=KCa8UfqvwgE"
        },
        codeButton: {
            label: "💻 Source Code",
    ...
    },
    {
        ...
        demoButton: {
            label: "🎬 Watch Video",
            url: "https://www.youtube.com/watch?v=s2sxdOOm-tw"
        },
        codeButton: {
            label: "💻 Source Code",
